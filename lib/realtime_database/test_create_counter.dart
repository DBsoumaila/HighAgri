...
Future<void> main() async {
  ...
  runApp(MaterialApp(
    ...
    home: MyHomePageTestCounter(app: app),
  ));
}

class MyHomePageTestCounter extends StatefulWidget {
  const MyHomePageTestCounter({Key? key, required this.app}) : super(key: key);
...
class _MyHomePageState extends State<MyHomePageTestCounter> {
  int _counter = 0;
