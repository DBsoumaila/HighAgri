...
import 'package:ha2/serviceAnalyse/takepicture/take_fraise.dart';
...
class AnalyseFraise extends StatefulWidget {
  final String titre;
...
class _ServicesPageState extends State<AnalyseFraise> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      appBar: AppBar(
        title: Text('Services de Fraises'),
        centerTitle: true,
