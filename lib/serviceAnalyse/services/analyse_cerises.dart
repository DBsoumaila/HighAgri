...
class AnalyseCerise extends StatefulWidget {
  final String titre;
...
class _ServicesPageState extends State<AnalyseCerise> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      appBar: AppBar(
        title: Text('Services de Cérises'),
        centerTitle: true,
