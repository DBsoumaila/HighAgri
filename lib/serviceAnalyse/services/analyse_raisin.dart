...
import 'package:ha2/serviceAnalyse/takepicture/take_raisin.dart';
...
class AnalyseRaisin extends StatefulWidget {
  final String titre;
...
class _ServicesPageState extends State<AnalyseRaisin> {
  ...
  Widget build(BuildContext context) => Scaffold(
      ...
      appBar: AppBar(
        title: Text('Services de Raisins'),
        centerTitle: true,
