...
class DisplayFraise extends StatelessWidget {
  final String imagePath;

  DisplayFraise({Key? key, required this.imagePath}) : super(key: key);
...
Future<Response> postImageToBackend(String urlImage) async {
  ...
  var dio = Dio();
  var url = 'https://strawberry-ago324jaqa-ey.a.run.app';
